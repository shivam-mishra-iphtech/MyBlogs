                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="widget widget_recent_post">
                        ...
                        <div class="single-post-list-wrap style-white">
                            <div class="media">
                                <div class="media-left">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/post/list/1.png" alt="img">
                                </div>
                        ...
                        <div class="single-post-list-wrap style-white">
                            <div class="media">
                                <div class="media-left">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/post/list/2.png" alt="img">
                                </div>
                                <div class="media-body">
                                    <div class="details">
                                        <div class="post-meta-single">
